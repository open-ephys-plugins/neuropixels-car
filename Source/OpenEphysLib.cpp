...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "Neuropixels CAR"; // <---- update
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//Processor name
		info->processor.name = "Neuropixels CAR"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<NeuropixelsCAR>);
		break;
	default:
		return -1;
		break;
